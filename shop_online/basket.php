<?php
    ...
    if (isset($_POST["submit"])) {
      ...
      if ($_POST["transport_id"] == "select") {
        ...
        $strSQL6 = "INSERT INTO order_list (order_ordernumber,order_date,order_price,order_img,member_id,transport_id) VALUES ('".$random_captcha."','".$_POST["order_date"]."','".$_POST["order_price"]."','".$_POST["order_img"]."','".$_POST["member_id"]."','".$_POST["transport_id"]."')";
    ...
    <div class="shop_div_7">
      <table class="shop_table_1">
        ...
        while ($objResult3 = mysqli_fetch_array($objQuery3,MYSQLI_ASSOC)) {
          ...
          <?php
          $total = $total + ($objResult3["product_price"] * $objResult3["basket_amount"]);
          $no++;
          }
        }
        ?>
