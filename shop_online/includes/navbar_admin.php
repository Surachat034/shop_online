...
<li><a href="../index.php"><i class="fa fa-home"></i> หน้าผู้ใช่งาน</a></li>
<!--
  <li class="dropdown">
  ...
  ?>
  <li><a href="index.php"><i class="fa fa-cogs"></i> ระบบหลังบ้าน</a></li>
  ...
  <li style="float:right"><a href=""><i class="fa fa-user"></i> สวัสดี  <?php echo $_SESSION["member_name"]; ?></a></li>
  <?php
  }
  ?>
  <?php
