...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2024 at 05:47 PM
...
(59, '147283395', '2024-08-20 16:19:45', 496, 'อยู่ระหว่างรอการส่งหลักฐานการโอนเงิน', 'ยังไม่ได้ส่งหลักฐานการโอนเงิน', 11, 1, NULL, ''),
...
--
ALTER TABLE `basket`
  MODIFY `basket_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=158;
